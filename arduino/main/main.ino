...
void setup(){
  ...
  display.setCursor(0,0); display.println("System Init..."); display.display();
...
void loop(){
  ...
  if(now-lastImuMs>=IMU_INTERVAL){
    ...
    if(now-lastDisplayMs>=DISPLAY_INTERVAL){
      ...
      display.setCursor(2,2); display.print("Health Monitor");
      display.setTextColor(SSD1306_WHITE);
      display.setTextSize(1);
      display.setCursor(2,16);
      display.print("ACC:");
      display.print(ax_g,2);display.print(",");
      display.print(ay_g,2);display.print(",");
      display.print(az_g,2);
      display.setCursor(2,26);
      display.print("GYR:");
      display.print(gx_dps,1);display.print(",");
      display.print(gy_dps,1);display.print(",");
      display.print(gz_dps,1);
      if(validHeartRate){ display.setCursor(2,38); display.print("HR:"); display.print(heartRate); display.print("bpm"); }
      if(validSPO2){ display.setCursor(2,48); display.print("SpO2:"); display.print(spo2); display.print("%"); }
      display.display();
    }
  }
  ...
  if(alert){ digitalWrite(VIBRATOR_PIN,HIGH); delay(200); digitalWrite(VIBRATOR_PIN,LOW); }
